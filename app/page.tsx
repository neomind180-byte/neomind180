...
export default function LandingPage() {
  ...
  // 1. Session Check: Take existing clients straight to the dashboard
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-[#00538e]/10">
      ...
      {/* 2. Responsive Header: Fixed collision and overlap */}
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-md border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-20 flex items-center justify-between gap-2">
          ...
          {/* Nav Area: Scaled for Mobile Chrome */}
      ...
      <main className="pt-32 pb-20 px-6">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <h2 className="text-5xl sm:text-7xl font-black text-slate-900 leading-[0.9] uppercase tracking-tighter">
            Calm the mind. <br />
            <span className="text-[#00538e]">Choose aligned action.</span>
          </h2>

          <p className="text-lg sm:text-xl text-slate-500 max-w-2xl mx-auto leading-relaxed">
            A grounded 5-phase coaching flow designed to help you separate from limiting thoughts and realise your true potential. 
          </p>
          ...
          <div className="pt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link 
              href="#how-it-works" 
              className="w-full sm:w-auto px-10 py-5 bg-white text-slate-400 border border-slate-100 rounded-[2rem] font-bold text-lg hover:bg-slate-50 transition-all"
            >
              Learn the Flow
            </Link>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-10 rounded-[3rem] border border-slate-100 space-y-4">
            ...
            <p className="text-sm text-slate-500 leading-relaxed">
              Experience deep-dive sessions with Neo, powered by Gemini 3 Flash, providing assertive and compassionate 180° shifts.
            </p>
          </div>
          ...
          <div className="bg-white p-10 rounded-[3rem] border border-slate-100 space-y-4">
            ...
            <p className="text-sm text-slate-500 leading-relaxed">
              Track your grounding levels and intentions daily to build a consistent habit of mental clarity and growth.
            </p>
          </div>
          ...
          <div className="bg-white p-10 rounded-[3rem] border border-slate-100 space-y-4">
            ...
            <p className="text-sm text-slate-500 leading-relaxed">
              Visualise your journey with mood trends and a historical record of every breakthrough you've achieved.
            </p>
          </div>
      ...
      <footer className="py-12 border-t border-slate-100">
        <div className="max-w-7xl mx-auto px-6 flex flex-col sm:flex-row justify-between items-center gap-6">
          <p className="text-[10px] font-black uppercase text-slate-400 tracking-widest">
            © 2026 NeoMind180. All rights reserved.
          </p>
