...
export default function HistoryPage() {
  ...
  if (loading) return <div className="p-10 text-center text-[var(--text-dim)] font-black uppercase tracking-widest text-[12px]">Loading History...</div>;
    ...
    <div className="min-h-screen bg-[var(--bg-primary)] font-sans text-[var(--text-secondary)] p-6 md:p-12">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <header className="flex items-center gap-4">
          ...
          <h1 className="text-3xl font-black uppercase tracking-tighter text-[var(--text-primary)]">Your Journey</h1>
        </header>
