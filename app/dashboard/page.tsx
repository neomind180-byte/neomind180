      ...
      <div className="flex justify-between items-center">
        {days.map((day, i) => (
          <div key={i} className="flex flex-col items-center gap-2">
            ...
            <div className={`w-7 h-7 rounded-full flex items-center justify-center transition-all ${weeklyStreak[i] ? "bg-[#0AA390] text-white shadow-lg shadow-[#0AA390]/20" : "bg-slate-50 text-slate-200"
              }`}>
    ...
    <div className="space-y-10 pb-20">
      ...
      <header className="flex justify-between items-center">
        ...
        <div className="flex items-center gap-3">
          <Link
            href="/pricing"
            className="flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-[#00538e] to-[#0AA390] rounded-full text-[10px] font-black uppercase text-white hover:shadow-lg transition-all"
          >
            Upgrade Plan
          </Link>
          <Link
