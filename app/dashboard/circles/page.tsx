...
export default function DeprecatedCirclesPage() {
  return (
    <div className="h-full min-h-screen flex flex-col items-center justify-center p-6 text-center animate-in fade-in duration-700 bg-[var(--bg-primary)]">
      <div className="w-24 h-24 bg-[#0AA390]/10 rounded-[2.5rem] flex items-center justify-center mb-8 border border-[#0AA390]/20 shadow-2xl shadow-[#0AA390]/10">
      ...
      <p className="text-[var(--text-muted)] max-w-lg mx-auto leading-relaxed mb-12 text-base font-medium italic">
        We have retired Deep-Dive Circles to focus 100% of our energy on high-touch daily AI reflections with Neo and direct Ask-the-Coach guidance.
      </p>
