      ...
      <div className="max-w-5xl mx-auto p-8 md:p-12 space-y-16">
        ...
        <section className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            <h2 className="text-2xl font-black text-[var(--text-primary)] uppercase tracking-tight border-l-4 border-[#0AA390] pl-6 py-1">
        ...
        {!loadingInvites && invites.length > 0 && (
          <section className="space-y-8">
            ...
            <div className="space-y-6">
              {invites.map((invite) => (
                <div key={invite.id} className="bg-[var(--bg-card)] border border-[#0AA390]/20 p-10 rounded-[3rem] shadow-xl space-y-6">
                  <div className="flex items-start justify-between">
                    <div className="space-y-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <h3 className="text-xl font-black text-[var(--text-primary)] uppercase tracking-tight">{invite.title}</h3>
                          {invite.session_date && (
