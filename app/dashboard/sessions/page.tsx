  ...
  return (
    <div className="min-h-screen bg-[var(--bg-primary)] font-sans text-[var(--text-secondary)]">
      <div className="max-w-5xl mx-auto p-8 md:p-12 space-y-16">
        ...
        {/* Scheduling Section */}
        <section className="bg-[var(--bg-card)] border border-[var(--border)] p-10 md:p-16 rounded-[4rem] shadow-2xl relative overflow-hidden flex flex-col lg:flex-row gap-16 items-center">
